module litepac/mastermind-go

go 1.24

require github.com/markus-wa/demoinfocs-golang/v5 v5.0.0
...
replace github.com/markus-wa/demoinfocs-golang/v5 => ../demoinfocs-parser
